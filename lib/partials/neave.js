module.exports = function() {
	...
	(function(Voronoi) {
		...
		Voronoi.init = function(width, height) {
			context = document.getCSSCanvasContext("2d", "voronoi", width, height);
	  ...
	  Voronoi.initMouse = function() {  // lel happens here , ömer
	...
	var init = function() {
	  Voronoi.stop();
	  Voronoi.init(window.innerWidth, window.innerHeight);
	  Voronoi.start();
	};
